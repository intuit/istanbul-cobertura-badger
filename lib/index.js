...
function istanbulCoberturaBadger(opts, callback) {
  ...
  opts = extend({
    ...
    // The type of shield icon to generate (plastic, flat-square, flat)
    shieldStyle: "flat",
  ...
  reportParser(opts.istanbulReportFile, function(err, report) {
    ...
    var url = opts.shieldsHost + "/badge/coverage-" + report.overallPercent + "%-" + color + ".svg?style=" + opts.shieldStyle;
