...
function istanbulCoberturaBadger(opts, callback) {
  ...
  opts.destinationDir = opts.destinationDir || null;
  // The shields host to be used for retrieving the badge. https://github.com/badges/shields
  opts.shieldsHost = opts.shieldsHost || process.env.SHIELDS_HOST || "https://img.shields.io"

  //if (!opts.destinationDir) {
  //  throw Error("The option 'destinationDir' must be provided");
  //}
